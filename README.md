...
- [数字图像——版权保护](数字图像/版权保护.md)
- [数字图像——图像置乱](数字图像/图像置乱.md)
- [一种基于加密域的数字图像水印算法的设计与实现](https://github.com/lyh2048/graduation_project)
